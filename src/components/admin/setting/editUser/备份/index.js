...
class editUser extends React.Component {
    ...
    addUser() {
        const {form: {userTrueName,userLoginName,userPassword,depId,position,workerNum,email,phone,pquesrion,panswer}} = this.state;    
        ...
        console.log('表单提交信息',this.state.editpassInit ? userPassword.value : this.refs.editpassword.getAttribute('data-up'))
        console.log('表单提交信息md5',userPassword.value)
        console.log('表单提交信息refs',this.refs.editpassword.getAttribute('data-up'))
                ...
                if(nextProps.editUserSucc){   
                    ...
                    _self.setState({
                        ...
                        form: {
                            ...
                            userPassword: {
                                valid: true,
                                value: nextProps.singleUserInfo.user.userPassword,
                                error: ''
                            },
                            depId:{
                    ...
                    // _self.SetTingSearchUserInfoActionCreator(nextProps.singleUserInfo.user.id);
                    // if(nextProps.singleUserSucc){
                    //     _self.SetTingEditOperatorCodeActionCreator(false,null);
                    // }
                }  
            }
    ...
    render() {
        ...
        console.log('用户修改状态',this.props.editUserSucc)
                        ...
                        <div className="form-col-ipt">
                            ...
                            <div className="ipt">
                                <div className='passwordShow'>
                                    <div className='editpassword' ref='editpassword' data-up={userPassword.value}>********</div>
                                    <div className='switchBtn'>
                                        <span style={{marginRight:'6px',color:'#333',fontSize:'14px'}}>更换密码:</span>
                                        <Switch checkedChildren="开" unCheckedChildren="关" onChange={this.changeIptPass.bind(this)}/>
                                    </div>
                                </div>
                                {
